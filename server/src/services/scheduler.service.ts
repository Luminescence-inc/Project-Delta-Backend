...
>>>>>>> 622ec33 (added js on the import (#43))
...
<<<<<<< HEAD
=======
  const jobOne = new SimpleIntervalJob({ minutes: 1 }, taskOne, { preventOverrun: true });
  const jobTwo = new SimpleIntervalJob({ minutes: 2 }, taskTwo, { preventOverrun: true });
